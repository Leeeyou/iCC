    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog dialog = new Dialog(MaterialDesignActivity.this, "Title", "创业前， 你只想努力2-3倍，从而得到相应的回报。 但真正创业后，你的竞争对手决定了你到底要有多辛苦。 而他们做出的决定都是一样的： 你能吃多少苦，我们就能吃多少苦，所以创业者才会很苦逼。\n" +
