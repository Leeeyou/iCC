...
package com.ly.cc.custom_controls.swipeback;
...
public class SwipeBackActivityHelper {
    ...
    public void convertActivityFromTranslucent() {
        try {
            ...
            Method method = Activity.class.getDeclaredMethod("convertFromTranslucent", translucentConversionListenerClazz);
            method.setAccessible(true);
            method.invoke(mActivity, translucentConversionListenerClazz);
        } catch (Throwable t) {
        }
    }
