package com.ly.cc.custom_controls.imagePainting;
...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs) {
        ...
        mBorderRadius = a.getDimensionPixelSize(R.styleable.RoundImageView_borderRadius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, BORDER_RADIUS_DEFAULT, getResources().getDisplayMetrics()));// 默认为10dp
    ...
    private void setUpShader() {
        ...
        //将bmp作为着色器，就是在指定区域内绘制bmp。渲染图像，使用图像为绘制图形着色
...
//        super.onDraw(canvas); //为什么去掉之后，背景色就没有了
